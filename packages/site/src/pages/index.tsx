        ...
        {showCreateAccountCard && !isAccount && (
          <Card
            content={{
              title: 'Pillars',
              description:
                'Aptos is a high-performance blockchain designed for scalability, security, and upgradeability, leveraging the Move programming language for smart contracts.',
            }}
        ...
        {showCreateAccountCard && !isAccount && (
          <Card
            content={{
              ...
              description:
                ' It employs a unique modular architecture with parallel transaction processing to achieve high throughput and low latency, aiming to drive widespread adoption of Web3 applications.',
            }}
            disabled={!state.installedSnap}
            fullWidth={
              isMetaMaskReady &&
